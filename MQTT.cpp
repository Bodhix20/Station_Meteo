...
namespace {
#define GROUP_NAME            "Bodhi"
#define DESTINATION_GROUP     "McIntoshMApourNoel"
#define MQTT_TOPIC_PUBLISH      "/estia/"DESTINATION_GROUP""
#define MQTT_TOPIC_SUBSCRIBE    "/estia/"GROUP_NAME""
